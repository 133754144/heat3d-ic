...
| 8192 | 2.742758 / 2.491700 | 477.496 / 3.760 | 1.191106 / 1.518798 | 13.810 / 12.109 | 0.029x | 3.220x | 177.0 |
| 16384 | 2.817371 / 2.534275 | 576.410 / 6.771 | 1.191235 / 1.519003 | 27.974 / 25.245 | 0.049x | 3.728x | 295.6 |
...
证据来源：A accuracy/graph 与 FVM field 为历史只读复用；A 的 8192/16384 timing 是本轮同 executor timing-only 补测。B/C valid32 accuracy/graph 与连续 warm/new-case span为本轮已有结果，GPU reconstruction-apply 为 timing-only。未重跑 FVM 或 A accuracy。8192 reconstruction-apply 首轮受 CUDA timer 抖动影响，正式值采用预先不看 accuracy 的 100-repeat 复核。4096/32768 A timing 仍为历史协议，只有 8192/16384 可用于本轮 A/B/C 同口径横比。
