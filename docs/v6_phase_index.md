...
This index is the short route through role-scoped P1h/P1i evidence. Historical
raw evidence remains on its frozen research branches; `main` retains stable
runtime, canonical bindings, compact results and closeout/checker artifacts.
...
- 16384 is the frozen P1i reference operating point selected by the
  preregistered non-inferiority + latency-Pareto decision chain.
- 32768 provided only marginal point-global improvement while source/peak and
  resource costs did not improve consistently; it remains exploratory only.
...
The separately preregistered sealed IID is explicitly a post-development final
confirmation set. It remains ungenerated and unopened.
