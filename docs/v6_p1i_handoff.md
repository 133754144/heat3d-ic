...
- E16384 role: production/reference strategy and the only frozen route opened
  on corrected confirmatory test128.
...
- Resolution result: 16,384 + reconstruction is the main Pareto family;
  32,768 is retained only as exploratory scalability evidence and is not a
  formal production ranking cell.
...
- `test_iid` is already-opened corrected confirmatory evidence. The separately
  preregistered sealed IID set remains ungenerated and unopened.
