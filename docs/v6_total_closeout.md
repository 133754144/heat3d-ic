...
This is the compact V6 summary integrated into `main`. The complete
authoritative evidence remains on `research/v6-p1h-shared-support`; the exact
allowlist and archive commit are bound by
