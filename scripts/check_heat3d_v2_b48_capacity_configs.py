"""Smoke-check Heat3D v2 B48 capacity probe/long configs.
...
CONFIGS = [
    "configs/heat3d_v2/frozen_v1_e002_adamw_m2width_B48_base_mse_warmup_cosine_capacity_probe_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e002_adamw_m25width_B48_base_mse_warmup_cosine_capacity_probe_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e002_adamw_m3width_B48_base_mse_warmup_cosine_capacity_probe_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e002_adamw_m2depth_B48_base_mse_warmup_cosine_capacity_probe_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e002_adamw_m2width_B48_base_mse_warmup_cosine_mlp3_capacity_probe_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e400_adamw_m2width_B48_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e400_adamw_m25width_B48_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e400_adamw_m3width_B48_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e400_adamw_m2depth_B48_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e400_adamw_m2width_B48_base_mse_warmup_cosine_mlp3_stratified_seed0.yaml",
]
...
def main() -> None:
    ...
    print(f"Checked {len(CONFIGS)} Heat3D v2 B48 capacity configs.")
    print("Heat3D v2 B48 capacity config smoke passed.")
...
def _check_config(relative_path: str, config: dict[str, Any], command: list[str]) -> None:
    ...
    if int(model.get("processor_steps")) > 8:
        raise AssertionError(f"{relative_path}: steps>8 is not allowed")
