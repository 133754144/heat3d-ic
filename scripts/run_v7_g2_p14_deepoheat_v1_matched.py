    ...
    receipt = {
        **contract,
        ...
        "model": {
            ...
            "sampled_function_instances_processed": BATCH_FUNCTIONS * ITERATIONS,
            "pde_functions_per_iteration": BATCH_FUNCTIONS,
            "pde_residual_spatial_point_count": "not independently counted in runner; do not infer from sampled functions",
        },
