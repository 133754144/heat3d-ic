...
Status: registered and dry-run checked only. No training or evaluation has been
run for V4P1_12 in this task, so the <20% train-consistent IID test target is
not yet established.
