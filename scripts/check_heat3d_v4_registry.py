...
def _check_v4_baseline(row: Mapping[str, str]) -> None:
    ...
    for config, label in ((base, "V4_base"), (resolved, "V4_baseline")):
        checks = {
            ...
            "dataset.name": "medium1024_gapA_full1024_v2",
            "dataset.subset_path": "data/heat3d-thermal-simulation/subsets/v1_multilayer_bc_eq_physics_label_medium1024_gapA_full1024_v2",
            "dataset.manifest_path": "configs/heat3d_v1_physics_label_medium1024_gapA_manifest.json",
            ...
            "export.prediction_split": "valid_iid",
...
def _desired_config_from_row(row: Mapping[str, str]) -> dict[str, Any]:
    ...
    return {
        ...
        "export": {
            ...
            "prediction_split": row["prediction_split"],
...
def _assert_registry_matches_resolved(
    ...
    checks = {
        ...
        "dataset.subset_path": row["subset_path"],
        "dataset.manifest_path": row["manifest_path"],
        ...
        "export.prediction_split": row["prediction_split"],
