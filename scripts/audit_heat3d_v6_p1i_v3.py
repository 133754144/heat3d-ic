#!/usr/bin/env python3
"""Audit the frozen V6-P1i pilot128_v3 without training or model inference."""
...
def audit() -> dict[str, Any]:
    ...
    if len(samples) != 128 or len(inputs) != 128:
        raise RuntimeError("pilot128_v3 row count drifted")
    ...
    return {
        "schema_version": "heat3d_v6_p1i_pilot128_v3_audit_v1",
...
def _markdown(report: Mapping[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "The frozen 128 cases were audited without filtering, replacement, "
            "training, or model inference. A failed pilot is retained as a "
            "negative qualification result and cannot authorize formal1024_v1.",
            "",
            "## Temperature coverage",
            "",
            f"- 30--150 K: {temperature['inside_primary_count']}/128 "
