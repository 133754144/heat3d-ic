...
def main() -> int:
    ...
    rows += [
        {"system": "E16384", "semantic": "fresh_single_case", "backend_or_processes": neural["winner"], "batch": 1, "median_seconds": neural["fresh_b1"]["median_seconds"], "p95_seconds": neural["fresh_b1"]["p95_seconds"], "samples_per_second": 1.0 / neural["fresh_b1"]["median_seconds"], "marginal_added_case_seconds": "", "speedup_vs_fvm": 1.0 / (fvm_sps * neural["fresh_b1"]["median_seconds"]), "peak_vram_bytes": neural["peak_vram_bytes"], "provenance": str(args.neural)},
