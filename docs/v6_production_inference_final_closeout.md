...
4096 remains the general default. 8192 is frozen as the balanced full-field
mode because it materially lowers reconstructed full-field RMSE. 16384 is the
highest IID-average full-field accuracy mode; 32768 remains experimental
seed0-only.
