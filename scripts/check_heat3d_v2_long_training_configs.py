"""Smoke-check long Heat3D v2 training configs.

Dry-run only: this script loads YAML configs and builds commands. It does not
import the training runner, read datasets, create output directories, or start
training.
"""
...
CONFIGS = [
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e400_adamw_m15_B96_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_stratified_seed1.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_stratified_seed2.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_clip0p5_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_clip0p1_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_wd1e3_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_warmup_cosine_wd1e2_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_light_bg_over_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_light_bg_bias_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_light_bg_bias_over_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m125_B96_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m125_B128_base_mse_warmup_cosine_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m125_B96_base_mse_lr3e4_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m125_B128_base_mse_lr3e4_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_lr3e4_stratified_seed0.yaml",
    "configs/heat3d_v2/frozen_v1_e300_adamw_m15_B96_base_mse_lr3e4_clip0p5_stratified_seed0.yaml",
]
...
def main() -> None:
    ...
    print(f"Checked {len(CONFIGS)} Heat3D v2 long-training configs.")
    print(
        "Priority counts: "
        + ", ".join(
    ...
    print("Heat3D v2 long training config smoke passed.")
...
def _check_config(relative_path: str, config: dict[str, Any], command: list[str]) -> None:
    ...
    if run.get("epochs") not in {300, 400}:
        raise AssertionError(f"{relative_path}: expected epochs=300 or 400")
    ...
    if run.get("validation_batch_size") != batch_size:
        raise AssertionError(f"{relative_path}: validation_batch_size must match batch_size")
    if run.get("prediction_batch_size") != batch_size:
    ...
    if loss.get("mode") == "mse":
        ...
        if max(weights) > 0.02 or sum(weights) <= 0.0:
            raise AssertionError(f"{relative_path}: background weights are not light")
    else:
