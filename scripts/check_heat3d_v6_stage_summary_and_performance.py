...
def main():
 ...
 for token in ('Fresh single-case latency','Warm/resident latency','Marginal added-case latency','Batch throughput','E16384-reconstruction','U-v2','停止 valid32 架构调优'): assert token in text
